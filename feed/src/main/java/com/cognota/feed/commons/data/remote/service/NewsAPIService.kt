...
import com.cognota.feed.search.data.SearchFeedResponse
...
interface NewsAPIService {
    ...
    @GET("newsv2/search.php")
    suspend fun searchFeeds(@Query("text") query: String): Response<SearchFeedResponse>
